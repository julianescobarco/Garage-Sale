...
public class UsuarioController implements IUsuarioController {
    ...
    public String login(String username, String contrasena) {
     ...
     @Override
    public String register(String username, String contrasena, String nombres, String apellidos, String email,
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Usuario usuario = new Usuario(username, contrasena,
                        nombres, apellidos, email, saldo, premium);
    ...
    public String modificar(String username, String nuevaContrasena, 
            String nuevosNombres, String nuevosApellidos,
    ...
    public String verVenta(String username) {
        ...
        DBConnection con = new DBConnection();
        String sql = "Select id,count(*) as num_inventario from venta where username = '" 
        ...
        try {
            ...
            while (rs.next()) {
                ...
                inventario.put(id, num_copias);
            }

            devolverProducto(username, inventario);
    ...
    @Override
    public String devolverProducto(String username, Map<Integer, Integer> inventario) {

        DBConnection con = new DBConnection();

        try {
            for (Map.Entry<Integer, Integer> producto : inventario.entrySet()) {
                int id = producto.getKey();
                int num_inventario = producto.getValue();

                String sql = "Update producto set inventario = (Select inventario + " + num_inventario +
